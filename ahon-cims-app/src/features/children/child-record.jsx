...
const AccessModule = () => {
  ...
  const openEdit = (child) => {
    // instead of opening the modal, go to ChildProfile page
      ...
      <main className="access-module-container">
        <div className="access-header-row">
          ...
          <div className="right-group">
            ...
            {/* "Add New Child" keeps using openModal */}
            ...
            <ul className="child-records-list">
              {childrenList.map(child => (
                <ChildCard
                  key={child.id}
                  child={child}
                  onSelect={openEdit}   // card click / View Details now goes to profile
                />
              ))}
            </ul>
          )}
        ...
        {/* modal for Add / (legacy) Edit remains unchanged */}
        {isModalOpen && (
